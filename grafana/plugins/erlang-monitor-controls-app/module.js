          ...
          alerts.length ? alerts.map((alert, index) => {
            ...
            return h$2('details', { className: 'eo-alert', key: alert.fingerprint, open: index === 0 },
              ...
              h$2('div', { className: 'eo-alert-body' },
                ...
                h$2('div', { className: 'eo-alert-line' }, h$2('div', { className: 'eo-alert-label' }, '辅助分析'), h$2('a', { className: 'eo-holmes', href: `/a/erlang-monitor-controls-app/ops-agent?${params.toString()}` }, '打开运维 Agent'))));
